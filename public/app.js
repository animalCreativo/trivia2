...
},{"assert":11,"global/document":6,"global/window":7}],13:[function(require,module,exports){
(function (process){
...
},{"_process":3,"path-to-regexp":15}],14:[function(require,module,exports){
...
},{"./update-events.js":25,"bel":1,"morphdom":10}],25:[function(require,module,exports){
module.exports = [
...
function questionwato(ctx, next) {
	request.get('/getWinner').end(function (err, res) {
...
},{"./template":27,"empty-element":5,"page":13,"superagent":16,"yo-yo":24}],27:[function(require,module,exports){
'use strict';
...
},{"yo-yo":24}],28:[function(require,module,exports){
'use strict';
...
},{"./findWinner":26,"./login":29,"./loser":31,"./question1":33,"./question2":35,"./question3":37,"./winner":39,"page":13}],29:[function(require,module,exports){
'use strict';
...
},{"yo-yo":24}],31:[function(require,module,exports){
'use strict';
...
},{"./template":32,"empty-element":5,"page":13,"superagent":16,"yo-yo":24}],32:[function(require,module,exports){
'use strict';
...
},{"yo-yo":24}],33:[function(require,module,exports){
'use strict';
...
},{"yo-yo":24}],35:[function(require,module,exports){
'use strict';
...
},{"./template":36,"empty-element":5,"page":13,"superagent":16,"yo-yo":24}],36:[function(require,module,exports){
'use strict';
...
},{"yo-yo":24}],37:[function(require,module,exports){
'use strict';
...
function questionwato(ctx, next) {
	request.get('/q3').end(function (err, res) {
		if (err) return console.log(err);
		var json = JSON.stringify(res.body);
		var jsonObj = jQuery.parseJSON(json);
		console.log("datos server2:" + json);
...
function saveUserWin(ctx, next) {
	request.post('/users').send({ username: local_username, email: local_email, trivia: true }) // sends a JSON post body
...
function saveUserLoser(ctx, next) {
	request.post('/users').send({ username: local_username, email: local_email, trivia: false }) // sends a JSON post body
	.set('X-API-Key', 'foobar').set('accept', 'json').end(function (err, res) {
		// Calling the end function will send the request
	});
}

},{"./template":38,"empty-element":5,"page":13,"superagent":16,"yo-yo":24}],38:[function(require,module,exports){
'use strict';
...
},{"yo-yo":24}],39:[function(require,module,exports){
'use strict';
...
},{"./template":40,"empty-element":5,"page":13,"superagent":16,"yo-yo":24}],40:[function(require,module,exports){
'use strict';
